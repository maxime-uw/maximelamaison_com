      ...
      <div class="container my-container">
        <div class="row-fluid">
          <div class="span12">
            ...
            <hr />
            <div class="inSide">
              <p>My name is <span class="inText">Maxime LAMAISON</span>, 23 years old french student in computing in Bordeaux (France).</p>
              <p>I'm interrested in <span class="inText">WebDesign</span>, mobile software development, design, but also in sports, music, clothes & so more...</p>
              <p style="text-align: center;">V2 still in design<!--  but you can check my old stuff here. --></p>
            </div>
          </div>
        </div>
        <hr />
        <div class="inSide lined">
          ...
          <div class="row-fluid">
            ...
            <div class="span6">& I'm a crazy programer <img src="assets/img/glyphicons_118_embed_close.png" alt="glyphicons_118_embed_close" width="30" height="17"> </div>
          </div>
          <div class="row-fluid">
            <div class="span6"><img src="assets/img/surf.png" alt="surf" width="25" height="17"> I pratice sports regulary...</div>
